...
python scripts/debugger.py start script.py --cwd /project/root          # set working dir (auto-loads .env there)
python scripts/debugger.py start script.py --env-file /path/to/.env     # explicit .env file
python scripts/debugger.py start script.py --cwd /project/root --env-file /other/.env
